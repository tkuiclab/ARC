...
if __name__ == '__main__':
   ...
   # task.robot_photo_pose()
    #task.Arm.pub_ikCmd('ptp', (0.30, 0.00 , 0.3), (-180, 0, 0))
    task.Arm.pub_ikCmd('ptp', (0.20, 0.00 , 0.4), (-90, 0, 0))
    task.Arm.pub_ikCmd('ptp', (0.20, 0.00 , 0.4), (-90, 90, 0))
    task.Arm.pub_ikCmd('ptp', (0.40, 0.00 , 0.4), (-90, 90, 0))
